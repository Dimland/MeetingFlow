...
The configured model and endpoint must support native JSON-schema structured output. Secrets must be supplied through environment variables or local secret storage and must not be committed.
